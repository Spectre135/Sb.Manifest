...
app.controller('payrollCtrl', function ($scope, $state, $window, apiService, config) {
    ...
    $scope.getPayrollList = function () {
        ...
        var url = config.hrDocApi + '/api/payroll/list';
        var params = {
    ...
    $scope.print = function () {
        ...
        var contents = document.getElementById('payrollList').innerHTML;
        ...
        frameDoc.document.write('<body style="font-size:14px;line-height:.7;"><div style="padding-left:25px;">');
